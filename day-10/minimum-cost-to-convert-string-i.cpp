class Solution {
    ...
    void FloyedWarshell(vector<vector<long long>> &adjMatrix, vector<char> & original, vector<char> &changed, vector<int> &cost) {
...
public:
    long long minimumCost(string source, string target, vector<char>& original, vector<char>& changed, vector<int>& cost) {
        ...
        FloyedWarshell(adjMatrix, original, changed, cost);
